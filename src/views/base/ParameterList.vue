<template>
  <div class="filter-container" style="padding-bottom: 0">
    <el-form :inline="true" size="small">
      ...
      <el-form-item>
        <el-button type="primary" icon="search" @click="getParameterList()">
          查询
        </el-button>
    ...
    ></el-pagination>
    <parameter-edit-form ref="editForm" @fetch-data="getParameterList" />
  </div>
</template>

<script>
  import { deleteParameter, getParameterList } from '@/api/parameter'
  import ParameterEditForm from './modules/ParameterEditForm'
  ...
  export default {
    ...
    methods: {
      ...
      getParameterList() {
        ...
        getParameterList(params).then((response) => {
